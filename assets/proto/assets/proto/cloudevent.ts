...
export const CloudEventServiceService = {
    ...
    subscribe: {
        ...
        requestStream: false,
        responseStream: true,
        requestSerialize: (value: SubscriptionRequest) =>
            Buffer.from(SubscriptionRequest.encode(value).finish()),
        requestDeserialize: (value: Buffer) =>
            SubscriptionRequest.decode(value),
        responseSerialize: (value: CloudEvent) =>
            Buffer.from(CloudEvent.encode(value).finish()),
