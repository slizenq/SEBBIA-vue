...
export const LoginData: MessageFns<LoginData> = {
  ...
  fromPartial<I extends Exact<DeepPartial<LoginData>, I>>(object: I): LoginData {
    const message = createBaseLoginData();
...
export const RefreshToken: MessageFns<RefreshToken> = {
  encode(message: RefreshToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.refreshToken !== undefined) {
      Token.encode(message.refreshToken, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): RefreshToken {
    return { refreshToken: isSet(object.refreshToken) ? Token.fromJSON(object.refreshToken) : undefined };
  },
...
export const PairTokens: MessageFns<PairTokens> = {
  encode(message: PairTokens, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.accessToken !== undefined) {
      AccessToken.encode(message.accessToken, writer.uint32(10).fork()).join();
    }
    if (message.refreshToken !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PairTokens {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PairTokens {
    return {
      ...
      refreshToken: isSet(object.refreshToken) ? RefreshToken.fromJSON(object.refreshToken) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PairTokens>, I>>(object: I): PairTokens {
    const message = createBasePairTokens();
    message.accessToken = (object.accessToken !== undefined && object.accessToken !== null)
...
export const NewPassword: MessageFns<NewPassword> = {
  encode(message: NewPassword, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.oldPassword !== undefined) {
      Password.encode(message.oldPassword, writer.uint32(10).fork()).join();
    }
    if (message.password !== undefined) {
      Password.encode(message.password, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NewPassword {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.oldPassword = Password.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): NewPassword {
    return {
      oldPassword: isSet(object.oldPassword) ? Password.fromJSON(object.oldPassword) : undefined,
      password: isSet(object.password) ? Password.fromJSON(object.password) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<NewPassword>, I>>(base?: I): NewPassword {
    return NewPassword.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NewPassword>, I>>(object: I): NewPassword {
    const message = createBaseNewPassword();
...
export const NewEmail: MessageFns<NewEmail> = {
  encode(message: NewEmail, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== undefined) {
      Email.encode(message.email, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NewEmail {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<NewEmail>, I>>(object: I): NewEmail {
    const message = createBaseNewEmail();
    message.email = (object.email !== undefined && object.email !== null) ? Email.fromPartial(object.email) : undefined;
    return message;
  },
...
export const RestorePasswordRequest: MessageFns<RestorePasswordRequest> = {
  encode(message: RestorePasswordRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== undefined) {
      Email.encode(message.email, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RestorePasswordRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<RestorePasswordRequest>, I>>(base?: I): RestorePasswordRequest {
    return RestorePasswordRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RestorePasswordRequest>, I>>(object: I): RestorePasswordRequest {
    const message = createBaseRestorePasswordRequest();
    message.email = (object.email !== undefined && object.email !== null) ? Email.fromPartial(object.email) : undefined;
...
export const TokensWithUserInfo: MessageFns<TokensWithUserInfo> = {
  encode(message: TokensWithUserInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.accessToken !== undefined) {
      AccessToken.encode(message.accessToken, writer.uint32(10).fork()).join();
    }
    if (message.refreshToken !== undefined) {
    ...
    if (message.account !== undefined) {
      AccountInfo.encode(message.account, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TokensWithUserInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.account = AccountInfo.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TokensWithUserInfo {
    return {
      accessToken: isSet(object.accessToken) ? AccessToken.fromJSON(object.accessToken) : undefined,
      refreshToken: isSet(object.refreshToken) ? RefreshToken.fromJSON(object.refreshToken) : undefined,
      account: isSet(object.account) ? AccountInfo.fromJSON(object.account) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<TokensWithUserInfo>, I>>(base?: I): TokensWithUserInfo {
    return TokensWithUserInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TokensWithUserInfo>, I>>(object: I): TokensWithUserInfo {
    const message = createBaseTokensWithUserInfo();
    message.accessToken = (object.accessToken !== undefined && object.accessToken !== null)
      ? AccessToken.fromPartial(object.accessToken)
      : undefined;
...
export class SSOServerServiceClientImpl implements SSOServerService {
  ...
  SignUp(request: Account): Promise<TokensWithUserInfo> {
    ...
    return promise.then((data) => TokensWithUserInfo.decode(new BinaryReader(data)));
  }
  ...
  RotateTokens(request: RefreshToken): Promise<PairTokens> {
    ...
    return promise.then((data) => PairTokens.decode(new BinaryReader(data)));
  }
  ...
  CheckOTP(request: OTPRequest): Promise<OTPResponse> {
    ...
    return promise.then((data) => OTPResponse.decode(new BinaryReader(data)));
  }
  ...
  LogoutFromDevices(request: Empty): Promise<Empty> {
    const data = Empty.encode(request).finish();
    const promise = this.rpc.request(this.service, "LogoutFromDevices", data);
    return promise.then((data) => Empty.decode(new BinaryReader(data)));
  }
}
