...
export const Vacancy: MessageFns<Vacancy> = {
  encode(message: Vacancy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.directions) {
      Direction.encode(v!, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Vacancy {
...
export const CreateVacancyRequest: MessageFns<CreateVacancyRequest> = {
  encode(message: CreateVacancyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.vacancy !== undefined) {
      Vacancy.encode(message.vacancy, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateVacancyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateVacancyRequest: MessageFns<UpdateVacancyRequest> = {
  encode(message: UpdateVacancyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.vacancy !== undefined) {
      Vacancy.encode(message.vacancy, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateVacancyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VacancyResponse: MessageFns<VacancyResponse> = {
  encode(message: VacancyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.vacancy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VacancyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VacancyCreated: MessageFns<VacancyCreated> = {
  encode(message: VacancyCreated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.vacancy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VacancyCreated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VacancyUpdated: MessageFns<VacancyUpdated> = {
  encode(message: VacancyUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.vacancy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VacancyUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetVacancyByIdRequest: MessageFns<GetVacancyByIdRequest> = {
  encode(message: GetVacancyByIdRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetVacancyByIdRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetVacanciesByParamsRequest: MessageFns<GetVacanciesByParamsRequest> = {
  encode(message: GetVacanciesByParamsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.expectedSkills) {
      Skill.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.aboutPractice !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetVacanciesByParamsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetVacanciesResponse: MessageFns<GetVacanciesResponse> = {
  encode(message: GetVacanciesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.vacancies) {
      VacancyWithId.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetVacanciesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VacancyWithId: MessageFns<VacancyWithId> = {
  encode(message: VacancyWithId, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    for (const v of message.expectedSkills) {
    ...
    for (const v of message.directions) {
      Direction.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.aboutProjects !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VacancyWithId {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class VacancyServiceClientImpl implements VacancyService {
  ...
  CreateVacancy(request: CreateVacancyRequest): Promise<VacancyResponse> {
    ...
    return promise.then((data) => VacancyResponse.decode(new BinaryReader(data)));
  }
  ...
  GetVacanciesByParams(request: GetVacanciesByParamsRequest): Promise<GetVacanciesResponse> {
    ...
    return promise.then((data) => GetVacanciesResponse.decode(new BinaryReader(data)));
  }
}
