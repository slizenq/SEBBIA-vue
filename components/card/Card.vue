    ...
    <el-card class="card">
        ...
        <div class="card-info" @click="openVacancy">
            ...
            <div class="card-info__education">
                ...
                <p class="education-title">Учебное заведение:<span class="education-title__span">{{ location }}</span></p>
            </div>
        ...
        <div class="send">
            ...
            <el-button type="default" :icon="TopRight" class="link" @click="openVacancy"/>
        </div>
    </el-card>
</template>
